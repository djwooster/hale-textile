  ...
  return (
    <section className="py-24 lg:py-32 bg-terracotta relative overflow-hidden">
      ...
      <div className="absolute top-8 left-8 opacity-15 pointer-events-none">
        <TextileMotif size={140} color="#FBF9F6" />
      </div>
      ...
      <div className="max-w-screen-xl mx-auto px-6 lg:px-12 relative z-10">
        <div className="max-w-2xl mx-auto text-center">
          <AnimatedSection>
            <p className="font-body text-[10px] tracking-[0.4em] uppercase text-warm-white/70 mb-5">
              Stay in the Loop
            </p>
            ...
            {!submitted ? (
              <form onSubmit={handleSubmit} className="flex flex-col sm:flex-row gap-0 max-w-md mx-auto">
                ...
                <button
                  type="submit"
                  className="bg-navy text-warm-white font-body text-[10px] tracking-[0.25em] uppercase font-medium px-7 py-4 hover:bg-navy-mid transition-colors duration-300 whitespace-nowrap"
                >
                  Subscribe
                </button>
              </form>
